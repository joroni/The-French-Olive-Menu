...
$sql = "select product_id, item_name, fitem_name,
		...
		price, fprice, sku, file_name from tblproducts WHERE category = $category";
 ...
 <?php foreach($product_list as $product) : ?>
                    <div class="item-prod box">
                        ...
                        <div class='arlang' dir='rtl' lang='ar' cite='Romeo and Juliet (II, ii, 1-2)'>
                         ...
                         <img class="example-image" src="../img/uploads/thumb_<? if(!empty($product['file_name']) AND file_exists("../img/uploads/".$product['file_name'])) {
